...
export interface DemoScene {
  ...
  /** Heuristic flag — scene contains language suggesting destructive intent. */
  destructive?: boolean;
  /** Keyword that triggered the destructive classifier, for transparency. */
  destructiveMatch?: string;
  /** When the executor skips this scene at runtime, the reason ends up here. */
  skipReason?: string;
}
